...
plot(CD_SN$GD, ylim = c(0, 0.2), main="SN", xlab="Index", ylab="GD", type="h")
abline(h = benchmark_GD_SN, lty = 3)
plot(CD_T$GD, ylim = c(0, 0.2), main="T", xlab="Index", ylab="GD", type="h")
abline(h = benchmark_GD_T, lty = 3)
plot(CD_ST$GD, ylim = c(0, 0.2), main="ST", xlab="Index", ylab="GD", type="h")
abline(h = benchmark_GD_ST, lty = 3)

##  Mahalanobis versus Weights
maha_N  <- (est_N$yhat -x%*%est_N$theta[1:p])^2/est_N$theta[p+1]
maha_SN <- (est_SN$yhat-x%*%est_SN$theta[1:p])^2/est_SN$theta[p+1]
...
par(mfrow=c(1,2))
plot(maha_T[cc==0], est_T$E00[cc==0], xlim=c(0,92), main="T", xlab = "Mahalanobis distance", ylab ="Weights", pch=3)
points(x = maha_T[cc==1], y = est_T$E00[cc==1], pch = 1, col = "red")
abline(h = 1)
plot(maha_ST[cc==0], est_ST$E00[cc==0], main="ST", xlab = "Mahalanobis distance", ylab ="Weights", pch=3)
...
plot(If_SN$Medida, ylim = c(0, 0.20), main ="SN", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_SN$Benchmark, lty = 3)
plot(If_SN2$Medida, ylim = c(0, 0.20), main ="SN", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_SN2$Benchmark, lty = 3)
plot(If_T$Medida, ylim = c(0, 0.06), main ="T", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_T$Benchmark, lty = 3)
plot(If_T2$Medida, ylim = c(0, 0.06), main ="T", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_T2$Benchmark, lty = 3)
plot(If_ST$Medida, ylim = c(0, 0.06), main ="ST", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_ST$Benchmark, lty = 3)
plot(If_ST2$Medida, ylim = c(0, 0.06), main ="ST", xlab = "Index", ylab="M(0)", type="h")
...
# GD Plots
par(mfrow=c(2,2))
plot(CD_N$GD, ylim = c(0, 0.15), main="N", xlab="Index", ylab="GD", type="h")
abline(h = benchmark_GD_N, lty = 3)
plot(CD_SN$GD, ylim = c(0, 0.12), main="SN", xlab="Index", ylab="GD", type="h")
abline(h = benchmark_GD_SN, lty = 3)
plot(CD_T$GD, ylim = c(0, 0.15), main="T", xlab="Index", ylab="GD", type="h")
abline(h = benchmark_GD_T, lty = 3)
...
### Figure. Case-weight and Scale perturbation
par(mfrow=c(4,2))
plot(If_N$Medida, ylim = c(0, 0.30), main ="N", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_N$Benchmark, lty = 3)
plot(If_N2$Medida, ylim = c(0, 0.30), main ="N", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_N2$Benchmark, lty = 3)
plot(If_SN$Medida, ylim = c(0, 1.00), main ="SN", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_SN$Benchmark, lty = 3)
plot(If_SN2$Medida, ylim = c(0, 0.30), main ="SN", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_SN2$Benchmark, lty = 3)
plot(If_T$Medida, ylim = c(0, 0.30), main ="T", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_T$Benchmark, lty = 3)
plot(If_T2$Medida, ylim = c(0, 0.30), main ="T", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_T2$Benchmark, lty = 3)
plot(If_ST$Medida, ylim = c(0, 1.00), main ="ST", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_ST$Benchmark, lty = 3)
plot(If_ST2$Medida, ylim = c(0, 0.30), main ="ST", xlab = "Index", ylab="M(0)", type="h")
abline(h = If_ST2$Benchmark, lty = 3)
